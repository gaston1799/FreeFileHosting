...
local State = remoteRequire("Forbidden/Packages/_Index/prooheckcp_robloxstatemachine@1.1.7/robloxstatemachine/Classes/State")
local Transition = remoteRequire("Forbidden/Packages/_Index/prooheckcp_robloxstatemachine@1.1.7/robloxstatemachine/Classes/Transition")
local Signal = remoteRequire("Forbidden/Packages/_Index/prooheckcp_robloxstatemachine@1.1.7/robloxstatemachine/Vendor/Signal")
local Trove = remoteRequire("Forbidden/Packages/_Index/prooheckcp_robloxstatemachine@1.1.7/robloxstatemachine/Vendor/Trove")
local Copy = remoteRequire("Forbidden/Packages/_Index/prooheckcp_robloxstatemachine@1.1.7/robloxstatemachine/Functions/deepCopy")
