...
local MathModule                = remoteRequire("Forbidden/Math")
local CMathRequests             = remoteRequire("Forbidden/AI/CommonMathRequests")
local ForbiddenDebugging        = remoteRequire("Forbidden/AI/Debugging")
local PositionalOptimization    = remoteRequire("Forbidden/AI/PositionalOptimization")
